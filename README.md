...
- [Text Processing ](#text-processing-commands)
- [Networking and Troubleshooting ](#networking-and-troubleshooting-commands)
- [SSH ](#ssh-commands)
- [Tmux ](#tmux-commands)
- [JQ ](#jq-commands)
- [Git ](#git-commands)
...
- [PostgreSQL ](#postgresql-commands)
- [MySQL ](#mysql-commands)
- [Redis ](#redis-commands)
- [Python ](#python-commands)
- [Node.js and NPM ](#nodejs-and-npm-commands)
- [Make ](#make-commands)
- [AWS CLI ](#aws-cli-commands)
- [Azure CLI ](#azure-cli-commands)
- [OpenSSL and Certificate ](#openssl-and-certificate-commands)
